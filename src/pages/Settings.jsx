...
const CHANGELOGS = [
  {
    date: "2026.08.28",
    changes: [
      "익명의 선생님이 추천해주신 기능! 학급 시간표도 '이번주 편집'으로 임시 교환할 수 있어요. (월요일 자동 초기화)",
      "익명의 선생님이 추천해주신 기능! 할 일의 D-Day 배지를 클릭하면 마감일을 바꾸거나 지울 수 있어요.",
  ...
  },
  {
    date: "2026.04.27",
    changes: [
      "학사일정에 월간 캘린더 뷰가 추가되었어요. (주간/월간 토글)",
      "월간 캘린더에서 날짜를 클릭하면 해당 날짜의 일정 팝오버가 떠요.",
      "쪽지함 버튼이 큼직한 동그란 프로필 사진으로 바뀌었어요. (클릭 시 쪽지함 이동)",
      "프로필 사진이 대시보드/쪽지함/채팅창 모두 동일하게 동기화돼요.",
      "채팅에서 내 메시지에도 내 프로필 사진이 표시돼요.",
      "안 읽은 쪽지 알림 뱃지가 더 크고 잘 보이게 개선되었어요.",
      "담임 선생님은 '학급 시간표' 탭을 추가해서 별도로 관리할 수 있어요. (설정 → 프로필)",
      "타이머 위젯이 제거되었어요.",
    ],
  },
  {
